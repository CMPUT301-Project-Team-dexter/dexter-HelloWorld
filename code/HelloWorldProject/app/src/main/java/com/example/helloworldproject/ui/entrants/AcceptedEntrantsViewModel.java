...
public class AcceptedEntrantsViewModel extends ViewModel {
    ...
    public AcceptedEntrantsViewModel(@NonNull EntrantRepository repo) { this.repo = repo; }
    ...
    private void reattach() {
        ...
        repo.listenAccepted(currentEventId, new EntrantRepository.ListenCallback() {
